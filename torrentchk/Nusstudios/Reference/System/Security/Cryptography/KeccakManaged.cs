...
namespace Nusstudios.Reference.System.Security.Cryptography {
	...
	/// </summary>
	[ComVisible(true)]
	public class KeccakManaged : Keccak {
		/// <summary>
		/// 
		/// </summary>
		public KeccakManaged()
			: base(512, false) { }
        ...
        public KeccakManaged(int hashBitLength, bool useStandardPadding)
            : base(hashBitLength, useStandardPadding) { }
		...
		protected override byte[] HashFinal() {
            ...
            // Padding is 0x06 for standard SHA-3, and 0x01 for original Keccak
            buffer[buffLength++] = (byte)(useStandardPadding ? 0x06 : 0x01);
